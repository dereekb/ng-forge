import { FormEvent, FieldDef, FormEventConstructor, StateLogicConfig, BaseCheckedField, BaseValueField, FieldMeta, FieldOption, ValidationMessages, ArrayAllowedChildren, NonFieldLogicConfig, NextPageEvent, PreviousPageEvent, FieldWithValidation } from '@ng-forge/dynamic-forms';
...
interface DatepickerField<TProps, TNullable extends boolean = boolean> extends BaseValueField<TProps, Date | string, FieldMeta, TNullable> {
    type: 'datepicker';
...
interface NumberInputField<TProps extends {
    type?: string;
} = InputProps, TNullable extends boolean = boolean> extends BaseValueField<TProps & {
    type: 'number';
}, number, InputMeta, TNullable> {
    type: 'input';
    props: TProps & {
        type: 'number';
    };
...
type BuildInputFieldUnion<TProps extends {
    type?: string;
}, TNullable extends boolean = boolean> = NumberInputField<TProps, TNullable> | StringInputField<TProps, TNullable>;
/**
 ...
 * };
 */
interface MultiCheckboxField<TValue, TProps = object, TNullable extends boolean = boolean> extends BaseValueField<TProps, TValue[], FieldMeta, TNullable> {
    type: 'multi-checkbox';
    readonly options: readonly FieldOption<TValue>[];
}

interface RadioField<T, TProps, TNullable extends boolean = boolean> extends BaseValueField<TProps, T, FieldMeta, TNullable> {
    type: 'radio';
 ...
 */
type SelectProps = object;
interface SelectField<T, TProps = SelectProps, TNullable extends boolean = boolean> extends BaseValueField<TProps, T, FieldMeta, TNullable> {
    type: 'select';
    readonly options: readonly FieldOption<T>[];
}

interface SliderField<TProps, TNullable extends boolean = boolean> extends BaseValueField<TProps, number, FieldMeta, TNullable> {
    type: 'slider';
    minValue?: number;
    maxValue?: number;
    step?: number;
...
interface TextareaField<TProps = TextareaProps, TNullable extends boolean = boolean> extends BaseValueField<TProps, string, TextareaMeta, TNullable> {
    type: 'textarea';
 ...
 */
declare function buildValueFieldInputs<TProps, TValue = unknown>(fieldDef: BaseValueField<TProps, TValue, FieldMeta, boolean>, ctx: ValueFieldContext, defaultProps?: Record<string, unknown>, defaultValidationMessages?: ValidationMessages): Record<string, unknown>;
/**
 ...
 */
declare function valueFieldMapper<TProps = unknown, TValue = unknown>(fieldDef: BaseValueField<TProps, TValue, FieldMeta, boolean>): Signal<Record<string, unknown>>;
