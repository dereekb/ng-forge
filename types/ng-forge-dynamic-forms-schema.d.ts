import { SchemaPath, SchemaPathTree } from '@angular/forms/signals';
 ...
 */
declare const STANDARD_SCHEMA_KIND: "standardSchema";
/**
 ...
 * ```
 */
type AngularSchemaCallback<T = unknown> = (path: SchemaPath<T> & SchemaPathTree<T>) => void;
/**
 ...
 * ```
 */
interface StandardSchemaMarker<out T = unknown> {
    /**
 ...
 * ```
 */
type FormSchema<T = unknown> = StandardSchemaMarker<T> | AngularSchemaCallback<T>;
/**
 ...
 * ```
 */
declare function standardSchema<T>(schema: StandardSchemaV1<T>): StandardSchemaMarker<T>;
/**
 ...
 * ```
 */
declare function isStandardSchemaMarker(value: unknown): value is StandardSchemaMarker;
/**
 ...
 */
type InferSchemaOutput<T> = T extends StandardSchemaV1<infer Output> ? Output : never;

export { isStandardSchemaMarker, standardSchema };
export type { AngularSchemaCallback, FormSchema, InferSchemaOutput, StandardSchemaMarker };
