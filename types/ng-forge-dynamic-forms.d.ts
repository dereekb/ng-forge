 ...
 * @public
 */
interface DeprecationWarningTracker {
 ...
 */
type RowAllowedChildren = Exclude<LeafFieldTypes, HiddenField> | GroupField | ArrayField | SimplifiedArrayField | ContainerField;
/**
 ...
 */
type ContainerAllowedChildren = Exclude<LeafFieldTypes, HiddenField> | RowField | GroupField | ArrayField | SimplifiedArrayField;
 ...
 */
declare const WRAPPER_REGISTRY: InjectionToken<Map<string, WrapperTypeDefinition<_ng_forge_dynamic_forms.CssWrapper | RowWrapper>>>;
...
interface BaseValueField<TProps, TValue, TMeta extends FieldMeta = FieldMeta> extends FieldDef<TProps, TMeta>, FieldWithValidation {
    value?: TValue;
    /**
...
declare function isValueField<TProps, TMeta extends FieldMeta = FieldMeta>(field: FieldDef<TProps, TMeta>): field is BaseValueField<TProps, ValueType, TMeta>;
type ExcludedKeys$1 = 'type' | 'conditionals' | 'value' | 'valueType' | 'disabled' | 'readonly' | 'hidden' | 'col' | 'minValue' | 'maxValue' | 'step' | 'required' | 'email' | 'min' | 'max' | 'minLength' | 'maxLength' | 'pattern' | 'validators' | 'logic' | 'derivation' | 'schemas' | 'excludeValueIfHidden' | 'excludeValueIfDisabled' | 'excludeValueIfReadonly' | 'wrappers' | 'skipAutoWrappers' | 'skipDefaultWrappers';
type ValueFieldComponent<T extends BaseValueField<Record<string, unknown> | unknown, unknown>> = Prettify<WithInputSignals<Omit<T, ExcludedKeys$1>>>;
...
declare class ContainerFieldComponent {
    ...
    field: _angular_core.InputSignal<ContainerField<readonly ContainerAllowedChildren[], readonly _ng_forge_dynamic_forms.WrapperConfig[]>>;
    key: _angular_core.InputSignal<string>;
    className: _angular_core.InputSignal<string | undefined>;
    hidden: _angular_core.InputSignal<boolean>;
    readonly hostClasses: _angular_core.Signal<string>;
